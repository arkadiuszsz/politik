...
class NeighbourTableSeeder extends Seeder {
	...
	public function run()
	{
		$borders = array(
			...
			'DE-RP' => array('DE-NW', 'DE-HW', 'DE-BW', 'FR-A', 'DE-SL'),
			...
			'PL-OP' => array('PL-WK', 'PL-LD', 'PL-SL', 'PL-DS'),
			...
			'PL-WN' => array('PL-PD', 'PL-MZ', 'PL-KP', 'PL-PO'),
			'PL-WP' => array('PL-PO', 'PL-KP', 'PL-LD', 'PL-OP', 'PL-DS', 'PL-LB', 'PL-ZP'),
			'PL-ZP' => array('PL-PO', 'PL-WP', 'PL-LB', 'PL-BB', 'PL-MV'),
			...
			'FR-G' => array('FR-H', 'FR-I', 'FR-D', 'FR-J', 'FR-S'),
			'FR-I' => array('FR-H', 'FR-A', 'FR-V', 'FR-D', 'FR-G'),
